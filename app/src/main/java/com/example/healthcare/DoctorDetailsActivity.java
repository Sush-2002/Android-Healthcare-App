...
public class DoctorDetailsActivity extends AppCompatActivity {
    ...
    private String[][] doctor_details2= {
            {"Doctor Name: Neelam Patil", "Hospital Address: Pimri", "Exp: 5yrs","Mobile No:9898989898", "600"},
    ...
    private String[][] doctor_details3= {
            {"Doctor Name: Seema Patil", "Hospital Address: Pimri", "Exp: 5yrs","Mobile No:9898989898", "600"},
    ...
    private String[][] doctor_details4= {
            {"Doctor Name: Amol Gawade", "Hospital Address: Pimri", "Exp: 5yrs","Mobile No:9898989898", "600"},
            {"Doctor Name: Prasad Pawar", "Hospital Address: Nigdi", "Exp: 15yrs","Mobile No:7898989898", "900"},
            {"Doctor Name: Nilesh Kale", "Hospital Address: Pune", "Exp: 8yrs","Mobile No:8898989898", "300"},
            {"Doctor Name: Deepak Deshpandey", "Hospital Address: Chinchwad", "Exp: 6yrs","Mobile No:9898000000", "500"},
            {"Doctor Name: Ashok Singh", "Hospital Address: Katraj", "Exp: 7yrs","Mobile No:7798989898", "800"}
    };
    private String[][] doctor_details5= {
            {"Doctor Name: Nilesh Borate", "Hospital Address: Pimri", "Exp: 5yrs","Mobile No:9898989898", "600"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn = findViewById(R.id.buttonBMAddToCart);
        Intent it = getIntent();
        ...
        ListView lst = findViewById(R.id.editTextBMDMultiLines);
        lst.setAdapter(sa);
